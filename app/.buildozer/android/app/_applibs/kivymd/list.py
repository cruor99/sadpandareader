...
<BaseListItem>
    ...
    BoxLayout:
        ...
        MDLabel:
            id: _lbl_primary
            text: root.text
            font_style: root.primary_font_style
        ...
        MDLabel:
            ...
            size_hint_y: root.secondary_size_hint_y
...
class BaseListItem(ThemableBehavior, RectangularRippleBehavior,
    ...
    primary_font_style = StringProperty("Subhead")
    secondary_font_style = StringProperty("Body1")
    secondary_size_hint_y = NumericProperty(None)
